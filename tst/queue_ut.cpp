...
TEST(queue, emplace_front_pop) {
    test::emplace_front_pop_T<int>();
    test::emplace_front_pop_T<unsigned int>();
    test::emplace_front_pop_T<size_t>();
    test::emplace_front_pop_T<float>();
    test::emplace_front_pop_T<double>();
    test::emplace_front_pop_T<char>();
    test::emplace_front_pop_T<std::string>();
    test::emplace_front_pop_T<test::CustomObject>();
}

TEST(queue, rvalue_push_front_pop) {
    test::rvalue_push_front_pop_T<int>();
    test::rvalue_push_front_pop_T<unsigned int>();
    test::rvalue_push_front_pop_T<size_t>();
    test::rvalue_push_front_pop_T<float>();
    test::rvalue_push_front_pop_T<double>();
    test::rvalue_push_front_pop_T<char>();
    test::rvalue_push_front_pop_T<std::string>();
    test::rvalue_push_front_pop_T<test::CustomObject>();
}

TEST(queue, lvalue_push_front_pop) {
    test::lvalue_push_front_pop_T<int>();
    test::lvalue_push_front_pop_T<unsigned int>();
    test::lvalue_push_front_pop_T<size_t>();
    test::lvalue_push_front_pop_T<float>();
    test::lvalue_push_front_pop_T<double>();
    test::lvalue_push_front_pop_T<char>();
    test::lvalue_push_front_pop_T<std::string>();
    test::lvalue_push_front_pop_T<test::CustomObject>();
}
